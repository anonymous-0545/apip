...
from src.model.sequence import SequenceModule
...
class APIP(nn.Module):
    def __init__(self, init_atom_features, init_bond_features, init_word_features, params, paramsExt):
        ...
        self.sequence_model = paramsExt.sequence_model
        self.stack = self.paramsExt.stack
        ...
        self.CNN_module = SequenceModule(init_atom_features, init_bond_features, init_word_features, params, paramsExt)
